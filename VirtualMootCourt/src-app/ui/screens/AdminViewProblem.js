...
import { Dimensions, ImageBackground, SafeAreaView, StyleSheet, Text, TouchableOpacity, View, FlatList } from "react-native";
...
const AdminViewProblemScreen = () => {
    ...
    const handleProblemPress = (selectedSynopsis) => {
        navigation.navigate('AdminProblemView', { selectedSynopsis });
    };
